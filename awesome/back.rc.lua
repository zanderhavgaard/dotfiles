...
-- lain.layout.cascade.tile.extra_padding = 20
...
-- TODO should be in theme? delete?
...
-- TODO which is the correct setup?
...
awful.rules.rules = {
    ...
    -- set to true to reenable titlebars
