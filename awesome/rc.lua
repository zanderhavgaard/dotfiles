...
if hostname == "nostromo" then
    ...
    startup_cmds = {
        ...
        "bash /home/zander/dotfiles/i3lock/start_i3lock.sh", "nm-applet",
        "volumeicon", "nextcloud", "/opt/piavpn/bin/pia-client", "caffeine"
    }
elseif hostname == "vostok" then
    ...
    startup_cmds = {
        ...
        "picom --config /home/zander/dotfiles/picom/picom.conf",
        "bash /home/zander/dotfiles/i3lock/start_i3lock.sh", "nm-applet",
        "volumeicon", "nextcloud", "/opt/piavpn/bin/pia-client",
        "blueman-applet", "caffeine"
    }
elseif hostname == "sulaco" then
    ...
    startup_cmds = {
        ...
        "picom --config /home/zander/dotfiles/picom/picom.conf",
        "bash /home/zander/dotfiles/i3lock/start_i3lock.sh", "nm-applet",
        "volumeicon", "blueman-applet", "caffeine"
    }
...
globalkeys = my_table.join( -- show keybindings help
    ...
    -- quit awesomewm
                 awful.key({modkey, controlkey, shiftkey}, "q", awesome.quit,
    ...
    -- lock the screen
                 awful.key({modkey, shiftkey, controlkey}, "l",
                           function() awful.spawn("i3lock -c 282C36") end, {
        description = "lock the screen",
        group = "launcher"
    }), -- switch keyboard language
    awful.key({modkey, shiftkey, controlkey}, "d",
              function() awful.spawn("setxkbmap dk") end,
    ...
    awful.key({modkey, shiftkey, controlkey}, "s",
    ...
    awful.key({}, "XF86MonBrightnessUp",
              ...
              {description = "increase brightness", group = "media controls"}),
    -- decrease brightness
...
clientkeys = my_table.join( -- toggle fullscreen
    ...
    awful.key({modkey, "Shift"}, "q", function(c) c:kill() end,
              {description = "close", group = "client"}), -- toggle floating
