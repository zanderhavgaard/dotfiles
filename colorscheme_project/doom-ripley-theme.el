...
(def-doom-theme doom-one
  ...
  ((bg         '("#18222B" nil       nil            ))
   ...
   (fg         '("#F8EEE1" "#F8EEE1" "brightwhite"  ))
   (fg-alt     '("#EFEBEA" "#EFEBEA" "white"        ))

   (grey       base4)
   (red        '("#E14A3B" "#E14A3B" "red"          ))
   (orange     '("#dd8844" "#FF7D46" "brightred"    ))
   (green      '("#73FE8C" "#73FE8C" "green"        ))
   (teal       '("#25615A" "#25615A" "brightgreen"  ))
   (yellow     '("#F8BE47" "#F8BE47" "yellow"       ))
   (blue       '("#3092D4" "#3092D4" "brightblue"   ))
   (dark-blue  '("#0055D0" "#0055D0" "blue"         ))
   (magenta    '("#DB629D" "#DB629D" "brightmagenta"))
   (violet     '("#CB89D0" "#CB89D0" "magenta"      ))
   (cyan       '("#4AA4E0" "#4AA4E0" "brightcyan"   ))
   (dark-cyan  '("#9EC0D9" "#9EC0D9" "cyan"         ))
